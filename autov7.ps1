...
$surveyEnabled = Get-AzConfig -DisplaySurveyMessage
if ($surveyEnabled -ne $null -and $surveyEnabled.Value) { Update-AzConfig -DisplaySurveyMessage $false -ErrorAction SilentlyContinue | Out-Null}
...
#Restoring survey settings
Update-AzConfig -DisplaySurveyMessage $surveyEnabled.Value -ErrorAction SilentlyContinue | Out-Null
Pop-Location
